...
async def test_llm_mock_insights():
    ...
    insights = await llm_service.generate_comparison_insights("Crisis A", "Crisis B", metrics)
...
def test_prompt_generation():
    metrics = {"tag_similarity": 0.5, "timeline_overlap": 0.2, "casualty_ratio": 0.1, "displacement_ratio": 0.1, "duration_delta_years": 10}

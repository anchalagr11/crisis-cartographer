...
def get_similar_crises(target_crisis_id: str, limit: int = 3) -> List[Dict[str, Any]]:
    ...
    target_crisis = next((c for c in all_crises if c.crisis_id == target_crisis_id), None)
    ...
    for crisis in all_crises:
        ...
        tag_sim = calculate_jaccard_similarity(target_crisis.cause_tags, crisis.cause_tags)
        ...
        recommendations.append({
            ...
            "common_tags": list(set(target_crisis.cause_tags) & set(crisis.cause_tags))
        })

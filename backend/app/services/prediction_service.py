...
def forecast_trajectory(crisis: Crisis) -> Dict[str, Any]:
    ...
    if crisis.status == CrisisStatus.ESCALATING:
        forecast_12m["risk_factors"].append("High probability of regional spillover based on intensity growth.")
    if not crisis.international_response or not crisis.international_response.un_involved:
        forecast_12m["risk_factors"].append("Lack of international mediation increases long-term volatility.")
